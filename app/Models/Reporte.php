...
class Reporte extends Model
{
  ...
  protected $fillable = [
    ...
    'personas_inscritas_total_victimas',
    'personas_inscritas_hombres_victimas',
    'personas_inscritas_mujeres_victimas',
    'remisiones_a_empleadores_total',
    'remisiones_a_empleadores_hombres',
    'remisiones_a_empleadores_mujeres',
    'remisiones_a_empleadores_total_a',
    'remisiones_a_empleadores_hombres_a',
    'remisiones_a_empleadores_mujeres_a',
    'remisiones_a_empleadores_total_bc',
    'remisiones_a_empleadores_hombres_bc',
    'remisiones_a_empleadores_mujeres_bc',
    'colocados_total',
    'colocados_hombres',
    'colocados_mujeres',
    'colocados_victimas',
